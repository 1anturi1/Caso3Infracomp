...
public class Cliente extends Task 
{
	...
	private static String generarCertificado(KeyPair llave)
			throws OperatorCreationException, java.security.cert.CertificateException, CertificateException {
	...
	public static java.security.cert.X509Certificate gc(KeyPair keyPair)
			throws OperatorCreationException, CertificateException, java.security.cert.CertificateException {
		...
		X509v3CertificateBuilder x509v3CertificateBuilder = new X509v3CertificateBuilder(new X500Name("CN=localhost"),
				BigInteger.valueOf(1L), Calendar.getInstance().getTime(), endCalendar.getTime(),
